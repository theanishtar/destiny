...
export class ProfileService {
    ...
    /* ============Hide or show information============= */
    private isOpenHideInfo = new BehaviorSubject<boolean>(false);
    isOpenHideInfo$ = this.isOpenHideInfo.asObservable();
    checkLoadingdata: boolean = false

    openModalHideInfo() {
        this.isOpenHideInfo.next(true);
    }
