...
public class AESStringKey {
	
	static String secretKeyString = "123456789";
//	static String secretKeyString = SecretDavisy.AES_KEY;
    ...
    public static SecretKey generateAesKey() throws Exception {
        KeyGenerator keyGenerator = KeyGenerator.getInstance("AESStringKey");
        keyGenerator.init(128); // Độ dài khóa AESStringKey là 128 bit
    ...
    public static SecretKey generateAesKey(String secretKeyString) {
        ...
        return new SecretKeySpec(keyData, "AESStringKey");
    }

    public static byte[] encryptData(String data, SecretKey secretKey) throws Exception {
        Cipher cipher = Cipher.getInstance("AESStringKey");
