...
public interface SendRecieverDAO extends JpaRepository<SendReciever, Integer> {
	...
	@Query(value = "select p.post_id,(select pi2.link_image  from post_images pi2 where pi2.post_id =p.post_id limit 1) AS link_image,u.fullname,p.\"content\",TO_CHAR(sr.date_send_reciever, 'DD-MM-YYYY') from post p \r\n"
