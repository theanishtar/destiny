...
public class MessageController {
	...
	public void sendMessage(@DestinationVariable int to, MessageModel message) {
		...
		Chats chats = chatsService.findChatNames(String.valueOf(user.getUser_id()), String.valueOf(to));
	...
	public ResponseEntity<List<Object[]>> loadMessages(HttpServletRequest request, @RequestBody String to) {
		try {
			...
			Chats chats = chatsService.findChatNames(String.valueOf(user.getUser_id()), to);
			if (chats != null) {
