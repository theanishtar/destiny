    ...
    app.querySelector(".form-counter", function (counters) {
      for (const counter of counters) {
        const value = counter.querySelector(".form-counter-value"),
          increaseButton = counter.querySelector(
            ".form-counter-control-increase"
          ),
          decreaseButton = counter.querySelector(
            ".form-counter-control-decrease"
          ),
